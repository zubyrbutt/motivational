...
import OscarWilde from '../images/Oscar _Wilde.jpg';
import QuotesScreen from './Quotes';
import { NavigationContainer } from '@react-navigation/native';
import { createStackNavigator } from '@react-navigation/stack';

import LaoTzuQuote from '../AllPhilosophers/LaoTzu'
import AlbertEinsteinQuotes from '../AllPhilosophers/AlbertEinstein'
                        ...
                        <View style={styles.listContainer}>
                            <View style={styles.imageCircle}>
                                <Image
                                    ...
                                    source={require('../images/laotzu.jpg')}/>
                            </View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('AlbertEinstein')}>
                        ...
                        <View style={styles.listContainer}>
                            <View style={styles.imageCircle}>
                                <Image
                                    style={styles.listImage}
                                    source={require('../images/AlbertEinstein.jpg')}/>
                            </View>
                            <View style={styles.textContainer}>
