...
import AbrahamLincolnQuotes from '../data/AbrahamLincoln'

const { width } = Dimensions.get('window');


export default class AbrahamLincoln extends Component {
    render() {
        return (
            ...
            >
                ...
                {
                    AbrahamLincolnQuotes.AbrahamLincoln.map(data => {
                        return (
                            ...
                            <View style={styles.container} key="{data.quotes}">
                                ...
                                <View style={styles.PoetryBox}>
                                    ...
                                    <Text style={styles.PoetName}>― Abraham Lincoln</Text>
                                </View>
                            </View>
                        );
                    })
